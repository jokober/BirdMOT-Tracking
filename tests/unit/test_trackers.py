...
from tests.fixtures.fixtures import dataset_config_dict_fixture, cocovid_images_fixture_dir, \
    sahi_prediction_params_dict_fixture, sahi_test_model_path, tracking_experiments_dict_fixture, tracking_oc_sort_experiment_dict_fixture
...
def test_oc_sort_tracker(tmp_path, dataset_config_dict_fixture, sahi_prediction_params_dict_fixture,
    ...
    for multiplier, one_experiment in enumerate(tracking_oc_sort_experiment_dict_fixture['tracker_experiments'], start=1):
