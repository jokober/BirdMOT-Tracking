...
def test_find_or_create_tracker_evaluations(tmp_path, dataset_config_dict_fixture, sahi_prediction_params_dict_fixture,
    ...
    one_experiment = tracking_experiments_dict_fixture['tracker_experiments'][0]
    ...
    ValueStorage.state_persistance = persistence_state